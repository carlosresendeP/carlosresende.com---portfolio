...
const MARQUEE_ITEMS = [
  'PROJETO', 'DISPONÍVEL', 'DESIGN',
  'DESENVOLVIMENTO', 'ENTREGA', 'FULLSTACK',
    ...
    <section id="cta" className="relative overflow-hidden bg-card/20">
      ...
      <div className="relative z-10 py-24 lg:py-36 w-full max-w-7xl mx-auto px-6 lg:px-16">
        <div className="flex flex-col items-center text-center gap-8 max-w-4xl mx-auto">
          ...
          >
            Vamos conversar sobre o seu projeto. Em menos de 24 horas você recebe
            um retorno com as melhores opções para o seu caso.
          </motion.p>
          ...
          >
            ...
            <a
              href={`https://wa.me/5532${process.env.NEXT_PUBLIC_PHONE_NUMBER}?text=Ol%C3%A1! Quero saber mais sobre seus servi%C3%A7os.`}
              target="_blank"
