    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Desenvolvedor full-stack criando soluções digitais modernas e de
              alta performance.
            </p>
            {/* Social links */}
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Tem um projeto em mente? Entre em contato e receba uma proposta
              personalizada.
            </p>
            <a
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          ...
          <p>
            Desenvolvido por{" "}
            <span className="text-primary">Carlos Resende</span>
          </p>
        </div>
      </div>
    </footer>
